    ...
    <div className="lg:hidden">
      ...
      {open && (
        <div className="fixed inset-0 z-50">
          ...
          />
          <div className="animate-fade-up absolute inset-x-0 bottom-0 flex max-h-[88vh] flex-col rounded-t-3xl bg-white shadow-2xl">
            <div className="flex shrink-0 items-center justify-between rounded-t-3xl bg-flame-500 px-5 py-4 text-white">
